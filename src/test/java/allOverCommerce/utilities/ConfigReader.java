...
public class ConfigReader {
    /*
        ...
        dosyasindaki bilgileri objemize yukler ve properties dosyasindaki key degerini return ederiz
          Bunu yapmak icin parametreli bir method olusturur girdigimiz key'in degerini bize döndurur
    ...
    static {
        try {
            ...
            properties.load(fis);//-->fis'in okudupu bilgileri properties'e yükler
        } catch (IOException e) {
